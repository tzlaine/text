...
namespace boost { namespace text {
    ...
    private:
        ...
        constexpr char8_t * read_into_buf()
        {
    ...
    private:
        ...
        constexpr char16_t * read_into_buf()
        {
    ...
    private:
        ...
        constexpr get_value_result get_value(char16_t curr) const
        {
            char32_t value = 0;
            I next = std::next(it_);
