...
#ifndef BOOST_TEXT_DETAIL_GENERATOR_HPP
#define BOOST_TEXT_DETAIL_GENERATOR_HPP
...
namespace boost::text::detail {
    ...
    // This code was originally part of Lewis Baker's very nice coro library:
    // https://github.com/lewissbaker/cppcoro .  Thanks, Lewis!
    ...
    public:
        ...
        // Iterator needs to be default-constructible to satisfy the Range
        // concept.
        ...
        // Need to provide post-increment operator to implement the 'Range'
        // concept.
