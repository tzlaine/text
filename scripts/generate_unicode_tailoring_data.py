...
# TODO: These need to be edited by hand.  These are the first two and the last
# two single-code-point entries in each language's section in
# FractionalUCD.txt.
group_cps = {
    ...
    'Bopo': [0x3105, 0x31A0, 0x31BE, 0x31BF],
    'Geor': [0x10D0, 0x2D00, 0x10FF, 0x1CBF],
    'Deva': [0x0950, 0xA8FD, 0x094C, 0x094D],
    'Cyrl': [0x0430, 0x2DF6, 0x04CF, 0x04C0],
    'Arab': [0x0621, 0x0674, 0x077B, 0x088E],
    ...
    'Tibt': [0x0F40, 0x0F69, 0x0F7D, 0x0F84],
...
inline std::string {0}_collation_tailoring()
{{
    std::string str;
{1}
    return str;
