...
parser = argparse.ArgumentParser(description='Downloads data files necessary for building Boost.Text\'s Unicode data, and generates those data.  NOTE: There is some manual intervention required in generate_unicode_collation_data.py and generate_unicode_tailoring_data.py (marked with TODO).  Handle that before using this script.')
