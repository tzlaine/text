...
const std::unordered_map<uint32_t, collation_elements> g_collation_element_table_{1} = {{
{0}
}};
...
static const std::array<detail::collation_trie_node, {1}> g_collation_trie_nodes = {{{{
{0}
}}}};
...
def flatten_trie(trie):
    ...
    for n in all_nodes:
        trie_lines += '    {{ {}, {}, {}, {{ {}, {}, }} }},\n'.format(
            hex(n.cp_), n.children_[0], n.children_[1],
