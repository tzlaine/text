...
bidi_brackets_header_form = decls = '''\
// Warning! This file is autogenerated.
...
hpp_file = open('bidi_brackets.hpp', 'w')
hpp_file.write(bidi_brackets_header_form.format(bidi_bracket_properties_lines, len(bidi_bracket_properties)))
