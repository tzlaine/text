...
cpp_file.write(canonical_file_form.format(decompositions_map, len(item_strings)))
...
cpp_file.write(compatible_file_form.format(decompositions_map, len(item_strings)))
