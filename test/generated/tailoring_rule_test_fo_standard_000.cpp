...
collation_table make_save_load_table()
{
    ...
    std::string const table_str(data::fo::standard_collation_tailoring());
    return tailored_collation_table(
        table_str,
        "fo::standard_collation_tailoring()", error, warning);
#else
    if (!exists(boost::filesystem::path("fo_standard.table"))) {
        std::string const table_str(data::fo::standard_collation_tailoring());
        collation_table table = tailored_collation_table(
            table_str,
            "fo::standard_collation_tailoring()", error, warning);
        save_table(table, "fo_standard.table.0");
        boost::filesystem::rename("fo_standard.table.0", "fo_standard.table");
    }
    return load_table("fo_standard.table");
#endif
}
