...
collation_table make_save_load_table()
{
    ...
    std::string const table_str(data::be::standard_collation_tailoring());
...
TEST(tailoring, be_standard_000_001)
{
    ...
    {
    // greater than (or equal to, for =) preceeding cps
    auto const res = std::vector<uint32_t>(1, 0x0443);
    auto const rel = std::vector<uint32_t>(1, 0x045e);
    std::string const res_str = to_string(res);
    std::string const rel_str = to_string(rel);
    auto const res_view = as_utf32(res);
    auto const rel_view = as_utf32(rel);
    ...
    {
    // greater than (or equal to, for =) preceeding cps
    auto const res = std::vector<uint32_t>(1, 0x045e);
    auto const rel = std::vector<uint32_t>(1, 0x040e);
    std::string const res_str = to_string(res);
    std::string const rel_str = to_string(rel);
    auto const res_view = as_utf32(res);
    auto const rel_view = as_utf32(rel);
