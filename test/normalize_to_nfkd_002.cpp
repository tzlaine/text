...
TEST(normalization, nfkd_002_008)
{
    ...
    // (ϒ; ϒ; ϒ; Υ; Υ; ) GREEK UPSILON WITH HOOK SYMBOL
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x03A5 }};
...
TEST(normalization, nfkd_002_013)
{
    ...
    // (ϰ; ϰ; ϰ; κ; κ; ) GREEK KAPPA SYMBOL
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x03BA }};
...
TEST(normalization, nfkd_002_015)
{
    ...
    // (ϲ; ϲ; ϲ; ς; ς; ) GREEK LUNATE SIGMA SYMBOL
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x03C2 }};
...
TEST(normalization, nfkd_002_016)
{
    ...
    // (ϴ; ϴ; ϴ; Θ; Θ; ) GREEK CAPITAL THETA SYMBOL
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x0398 }};
...
TEST(normalization, nfkd_002_017)
{
    ...
    // (ϵ; ϵ; ϵ; ε; ε; ) GREEK LUNATE EPSILON SYMBOL
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x03B5 }};
...
TEST(normalization, nfkd_002_018)
{
    ...
    // (Ϲ; Ϲ; Ϲ; Σ; Σ; ) GREEK CAPITAL LUNATE SIGMA SYMBOL
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x03A3 }};
...
TEST(normalization, nfkd_002_071)
{
    ...
    // (և; և; և; եւ; եւ; ) ARMENIAN SMALL LIGATURE ECH YIWN
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0x0565, 0x0582 }};
...
TEST(normalization, nfkd_002_077)
{
    ...
    // (ٵ; ٵ; ٵ; اٴ; اٴ; ) ARABIC LETTER HIGH HAMZA ALEF
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0x0627, 0x0674 }};
...
TEST(normalization, nfkd_002_078)
{
    ...
    // (ٶ; ٶ; ٶ; وٴ; وٴ; ) ARABIC LETTER HIGH HAMZA WAW
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0x0648, 0x0674 }};
...
TEST(normalization, nfkd_002_080)
{
    ...
    // (ٸ; ٸ; ٸ; يٴ; يٴ; ) ARABIC LETTER HIGH HAMZA YEH
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0x064A, 0x0674 }};
...
TEST(normalization, nfkd_002_128)
{
    ...
    // (ำ; ำ; ำ; ◌ํา; ◌ํา; ) THAI CHARACTER SARA AM
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0x0E4D, 0x0E32 }};
...
TEST(normalization, nfkd_002_129)
{
    ...
    // (ຳ; ຳ; ຳ; ◌ໍາ; ◌ໍາ; ) LAO VOWEL SIGN AM
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0x0ECD, 0x0EB2 }};
...
TEST(normalization, nfkd_002_130)
{
    ...
    // (ໜ; ໜ; ໜ; ຫນ; ຫນ; ) LAO HO NO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0x0EAB, 0x0E99 }};
...
TEST(normalization, nfkd_002_131)
{
    ...
    // (ໝ; ໝ; ໝ; ຫມ; ຫມ; ) LAO HO MO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0x0EAB, 0x0EA1 }};
...
TEST(normalization, nfkd_002_132)
{
    ...
    // (༌; ༌; ༌; ་; ་; ) TIBETAN MARK DELIMITER TSHEG BSTAR
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x0F0B }};
...
TEST(normalization, nfkd_002_142)
{
    ...
    // (◌ཷ; ◌ཷ; ◌ཷ; ◌ྲ◌ཱ◌ྀ; ◌ྲ◌ཱ◌ྀ; ) TIBETAN VOWEL SIGN VOCALIC RR
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x0FB2, 0x0F71, 0x0F80 }};
...
TEST(normalization, nfkd_002_144)
{
    ...
    // (◌ཹ; ◌ཹ; ◌ཹ; ◌ླ◌ཱ◌ྀ; ◌ླ◌ཱ◌ྀ; ) TIBETAN VOWEL SIGN VOCALIC LL
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x0FB3, 0x0F71, 0x0F80 }};
...
TEST(normalization, nfkd_002_153)
{
    ...
    // (ჼ; ჼ; ჼ; ნ; ნ; ) MODIFIER LETTER GEORGIAN NAR
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x10DC }};
...
TEST(normalization, nfkd_002_166)
{
    ...
    // (ᴭ; ᴭ; ᴭ; Æ; Æ; ) MODIFIER LETTER CAPITAL AE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x00C6 }};
...
TEST(normalization, nfkd_002_170)
{
    ...
    // (ᴲ; ᴲ; ᴲ; Ǝ; Ǝ; ) MODIFIER LETTER CAPITAL REVERSED E
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x018E }};
...
TEST(normalization, nfkd_002_180)
{
    ...
    // (ᴽ; ᴽ; ᴽ; Ȣ; Ȣ; ) MODIFIER LETTER CAPITAL OU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x0222 }};
...
TEST(normalization, nfkd_002_187)
{
    ...
    // (ᵄ; ᵄ; ᵄ; ɐ; ɐ; ) MODIFIER LETTER SMALL TURNED A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x0250 }};
...
TEST(normalization, nfkd_002_188)
{
    ...
    // (ᵅ; ᵅ; ᵅ; ɑ; ɑ; ) MODIFIER LETTER SMALL ALPHA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x0251 }};
...
TEST(normalization, nfkd_002_189)
{
    ...
    // (ᵆ; ᵆ; ᵆ; ᴂ; ᴂ; ) MODIFIER LETTER SMALL TURNED AE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x1D02 }};
...
TEST(normalization, nfkd_002_194)
{
    ...
    // (ᵋ; ᵋ; ᵋ; ɛ; ɛ; ) MODIFIER LETTER SMALL OPEN E
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x025B }};
...
TEST(normalization, nfkd_002_199)
{
    ...
    // (ᵑ; ᵑ; ᵑ; ŋ; ŋ; ) MODIFIER LETTER SMALL ENG
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x014B }};
