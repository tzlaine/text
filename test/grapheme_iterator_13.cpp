...
{
    {
        ...
        std::copy(
            boost::text::utf32_to_utf8_iterator<uint32_t const *>(cps, cps, cps + 5),
            boost::text::utf32_to_utf8_iterator<uint32_t const *>(cps, cps + 5, cps + 5),
            cus);
...
{
    {
        ...
        std::copy(
            boost::text::utf32_to_utf8_iterator<uint32_t const *>(cps, cps, cps + 4),
            boost::text::utf32_to_utf8_iterator<uint32_t const *>(cps, cps + 4, cps + 4),
            cus);
...
{
    {
        ...
        std::copy(
            boost::text::utf32_to_utf8_iterator<uint32_t const *>(cps, cps, cps + 6),
            boost::text::utf32_to_utf8_iterator<uint32_t const *>(cps, cps + 6, cps + 6),
            cus);
