...
TEST(line, breaks_72)
{
    ...
    // × [0.3] LEFT PARENTHESIS (OP) × [14.0] MONGOLIAN LETTER TODO TA (AL) × [28.0] MONGOLIAN LETTER TODO O (AL) × [28.0] MONGOLIAN LETTER TODO DA (AL) × [28.0] MONGOLIAN LETTER TODO O (AL) × [13.02] RIGHT PARENTHESIS (CP) ÷ [999.0] MONGOLIAN TODO SOFT HYPHEN (BB) × [21.04] MONGOLIAN LETTER BA (AL) × [28.0] MONGOLIAN LETTER I (AL) × [28.0] MONGOLIAN LETTER CHA (AL) × [28.0] MONGOLIAN LETTER I (AL) × [28.0] MONGOLIAN LETTER GA (AL) × [9.0] MONGOLIAN FREE VARIATION SELECTOR TWO (CM1_CM) ÷ [0.3]
    {
        ...
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 6, cps.end()) - cps.begin(), 13);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 11, cps.end()) - cps.begin(), 6);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 6, cps.end()) - cps.begin(), 13);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 12, cps.end()) - cps.begin(), 6);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 6, cps.end()) - cps.begin(), 13);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 13, cps.end()) - cps.begin(), 6);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 6, cps.end()) - cps.begin(), 13);
    }
    ...
    // × [0.3] LEFT CURLY BRACKET (OP) × [14.0] MONGOLIAN LETTER TODO TA (AL) × [28.0] MONGOLIAN LETTER TODO O (AL) × [28.0] MONGOLIAN LETTER TODO DA (AL) × [28.0] MONGOLIAN LETTER TODO O (AL) ÷ [999.0] MONGOLIAN TODO SOFT HYPHEN (BB) × [13.02] RIGHT CURLY BRACKET (CL) ÷ [999.0] MONGOLIAN LETTER BA (AL) × [28.0] MONGOLIAN LETTER I (AL) × [28.0] MONGOLIAN LETTER CHA (AL) × [28.0] MONGOLIAN LETTER I (AL) × [28.0] MONGOLIAN LETTER GA (AL) × [9.0] MONGOLIAN FREE VARIATION SELECTOR TWO (CM1_CM) ÷ [0.3]
    {
        ...
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 7, cps.end()) - cps.begin(), 13);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 11, cps.end()) - cps.begin(), 7);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 7, cps.end()) - cps.begin(), 13);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 12, cps.end()) - cps.begin(), 7);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 7, cps.end()) - cps.begin(), 13);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 13, cps.end()) - cps.begin(), 7);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 7, cps.end()) - cps.begin(), 13);
    }
    ...
    // × [0.3] LEFT PARENTHESIS (OP) × [14.0] DIGIT ZERO (NU) × [25.03] COMMA (IS) × [25.04] DIGIT ONE (NU) × [25.04] RIGHT PARENTHESIS (CP) × [25.05] PLUS SIGN (PR) × [25.01] LEFT PARENTHESIS (OP) × [14.0] DIGIT TWO (NU) × [25.03] COMMA (IS) × [25.04] DIGIT THREE (NU) × [25.04] RIGHT PARENTHESIS (CP) × [30.02] CIRCLED PLUS (AI_AL) × [30.01] LEFT PARENTHESIS (OP) × [14.0] MINUS SIGN (PR) × [25.01] DIGIT FOUR (NU) × [25.03] COMMA (IS) × [25.04] DIGIT FIVE (NU) × [25.04] RIGHT PARENTHESIS (CP) × [30.02] CIRCLED MINUS (AL) × [30.01] LEFT PARENTHESIS (OP) × [14.0] DIGIT SIX (NU) × [25.03] COMMA (IS) × [25.04] DIGIT SEVEN (NU) × [25.04] RIGHT PARENTHESIS (CP) ÷ [0.3]
    {
        ...
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 0, cps.end()) - cps.begin(), 24);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 22, cps.end()) - cps.begin(), 0);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 0, cps.end()) - cps.begin(), 24);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 23, cps.end()) - cps.begin(), 0);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 0, cps.end()) - cps.begin(), 24);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 24, cps.end()) - cps.begin(), 0);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 0, cps.end()) - cps.begin(), 24);
    }
    ...
    // × [0.3] LEFT CURLY BRACKET (OP) × [14.0] DIGIT ZERO (NU) × [25.03] COMMA (IS) × [25.04] DIGIT ONE (NU) × [25.04] RIGHT CURLY BRACKET (CL) × [25.05] PLUS SIGN (PR) × [25.01] LEFT CURLY BRACKET (OP) × [14.0] DIGIT TWO (NU) × [25.03] COMMA (IS) × [25.04] DIGIT THREE (NU) × [25.04] RIGHT CURLY BRACKET (CL) ÷ [999.0] CIRCLED PLUS (AI_AL) × [30.01] LEFT CURLY BRACKET (OP) × [14.0] MINUS SIGN (PR) × [25.01] DIGIT FOUR (NU) × [25.03] COMMA (IS) × [25.04] DIGIT FIVE (NU) × [25.04] RIGHT CURLY BRACKET (CL) ÷ [999.0] CIRCLED MINUS (AL) × [30.01] LEFT CURLY BRACKET (OP) × [14.0] DIGIT SIX (NU) × [25.03] COMMA (IS) × [25.04] DIGIT SEVEN (NU) × [25.04] RIGHT CURLY BRACKET (CL) ÷ [0.3]
    {
        ...
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 11, cps.end()) - cps.begin(), 18);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 18, cps.end()) - cps.begin(), 18);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 18, cps.end()) - cps.begin(), 24);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 19, cps.end()) - cps.begin(), 18);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 18, cps.end()) - cps.begin(), 24);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 20, cps.end()) - cps.begin(), 18);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 18, cps.end()) - cps.begin(), 24);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 21, cps.end()) - cps.begin(), 18);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 18, cps.end()) - cps.begin(), 24);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 22, cps.end()) - cps.begin(), 18);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 18, cps.end()) - cps.begin(), 24);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 23, cps.end()) - cps.begin(), 18);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 18, cps.end()) - cps.begin(), 24);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 24, cps.end()) - cps.begin(), 18);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 18, cps.end()) - cps.begin(), 24);
    }
    ...
    // × [0.3] HIRAGANA LETTER NI (ID) ÷ [999.0] LEFT CORNER BRACKET (OP) × [14.0] KATAKANA LETTER BA (ID) ÷ [999.0] LEFT PARENTHESIS (OP) × [14.0] LATIN SMALL LETTER B (AL) × [28.0] LATIN SMALL LETTER A (AL) × [13.02] RIGHT PARENTHESIS (CP) × [13.02] RIGHT CORNER BRACKET (CL) ÷ [999.0] HIRAGANA LETTER YA (ID) ÷ [999.0] LEFT CORNER BRACKET (OP) × [14.0] KATAKANA LETTER SU (ID) ÷ [0.3]
    {
        ...
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 3, cps.end()) - cps.begin(), 8);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 7, cps.end()) - cps.begin(), 3);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 3, cps.end()) - cps.begin(), 8);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 8, cps.end()) - cps.begin(), 8);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 8, cps.end()) - cps.begin(), 9);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 9, cps.end()) - cps.begin(), 9);
    ...
    // × [0.3] HIRAGANA LETTER HA (ID) × [13.02] IDEOGRAPHIC COMMA (CL) ÷ [999.0] LEFT CORNER BRACKET (OP) × [14.0] EQUALS SIGN (AL) × [28.0] LATIN SMALL LETTER R (AL) × [28.0] LATIN SMALL LETTER A (AL) × [28.0] LATIN SMALL LETTER N (AL) × [28.0] LATIN SMALL LETTER D (AL) × [30.01] LEFT PARENTHESIS (OP) × [13.02] RIGHT PARENTHESIS (CP) × [13.02] RIGHT CORNER BRACKET (CL) ÷ [999.0] HIRAGANA LETTER TO (ID) ÷ [0.3]
    {
        ...
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 2, cps.end()) - cps.begin(), 11);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 7, cps.end()) - cps.begin(), 2);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 2, cps.end()) - cps.begin(), 11);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 8, cps.end()) - cps.begin(), 2);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 2, cps.end()) - cps.begin(), 11);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 9, cps.end()) - cps.begin(), 2);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 2, cps.end()) - cps.begin(), 11);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 10, cps.end()) - cps.begin(), 2);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 2, cps.end()) - cps.begin(), 11);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 11, cps.end()) - cps.begin(), 11);
    ...
    // × [0.3] KATAKANA LETTER DE (ID) × [21.03] KATAKANA LETTER SMALL I (CJ_NS) ÷ [999.0] KATAKANA LETTER A (ID) ÷ [999.0] FULLWIDTH LEFT PARENTHESIS (OP) × [14.0] LATIN SMALL LETTER A (AL) × [28.0] LATIN SMALL LETTER B (AL) × [13.02] FULLWIDTH RIGHT PARENTHESIS (CL) × [13.02] RIGHT WHITE CORNER BRACKET (CL) ÷ [0.3]
    {
        ...
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 7, cps.end()) - cps.begin(), 3);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 3, cps.end()) - cps.begin(), 8);
        EXPECT_EQ(boost::text::prev_possible_line_break(cps.begin(), cps.begin() + 8, cps.end()) - cps.begin(), 3);
        EXPECT_EQ(boost::text::next_possible_line_break(cps.begin() + 3, cps.end()) - cps.begin(), 8);
    }
