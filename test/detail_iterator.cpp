...
TEST(const_repeated_chars_iterator, test_c_str_ctor)
{
    {
        text::text_view tv_empty("");
        text::detail::const_repeated_chars_iterator it(tv_empty.begin(), tv_empty.end(), 3);
...

    {
        ...
        text::detail::const_repeated_chars_iterator first(tv_abc.begin(), tv_abc.end(), 3);
        text::detail::const_repeated_chars_iterator last(tv_abc.begin(), tv_abc.end());
...
{ text::detail::const_repeated_chars_iterator it(tv_abc.begin(), tv_abc.end(), 3); return ++it; }
...
{ text::detail::const_repeated_chars_iterator it(tv_abc.begin(), tv_abc.end(), 3); return it += 9; }
...
TEST(const_repeated_chars_iterator, test_c_str_ctor_constexpr)
{
    {
        constexpr text::text_view tv_empty("");
        constexpr text::detail::const_repeated_chars_iterator it(tv_empty.begin(), tv_empty.end(), 3);
    ...
    {
        constexpr text::detail::const_repeated_chars_iterator first(tv_abc.begin(), tv_abc.end(), 3);
        constexpr text::detail::const_repeated_chars_iterator last(tv_abc.begin(), tv_abc.end());
