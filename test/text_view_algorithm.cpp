...
TEST(text_view_algorithm, word_break)
{
    ...
    text cps_("\x61\x5f\x61\x2e\x3a\x61");
    text_view cps = cps_;
...
TEST(text_view_algorithm, sentence_break)
{
    ...
    text cps_("\x65\x74\x63\x2e\xe5\xae\x83");
    text_view cps = cps_;
...
TEST(break_apis, line_break)
{
    ...
    // 80 columns -> don't take the allowed break in the middle.
    {
        auto const _80_column_lines = lines(
            cps,
            80,
            [](text_view::const_iterator::iterator_type it,
               text_view::const_iterator::iterator_type last) {
...
TEST(text_view_algorithm, paragraph_break)
{
    // ÷ 0065 × 0074 × 0063 × 002E ÷ 5B83 ÷
    // ÷ [0.2] LATIN SMALL LETTER E (Lower) × [998.0] LATIN SMALL LETTER T (Lower) × [998.0] LATIN SMALL LETTER C (Lower) × [998.0] FULL STOP (ATerm) ÷ [11.0] CJK UNIFIED IDEOGRAPH-5B83 (OLetter) ÷ [0.3]
    text cps_("\x65\x74\x63\x2e\xe5\xae\x83");
...
TEST(text_view_algorithm, bidi)
{
    ...
    text cps_(to_string(cp_vec.begin(), cp_vec.end()));
    text_view cps = cps_;
...
TEST(text_view_algorithm, coll_search_default)
{
    text const haystack_1_("NOW AN FOWE\220ER ANNMAN THE ANPANMANEND");
    text const needle_1_("ANPANMAN");
    text const needle_2_("MAN THE");
    text const needle_3_("WE\220ER");
    text const needle_4_("NOW ");
    text const needle_5_("NEND");
    text const needle_6_("NOT FOUND");
    text const needle_7_("NOT FO\340ND");

    text const haystack_2_("ABC ABCDAB ABCDABCDABDE");
    text const needle_11_("ABCDABD");

    text const haystack_3_("abra abracad abracadabra");
    text const needle_12_("abracadabra");

    text_view haystack_1 = haystack_1_;
    text_view needle_1 = needle_1_;
    text_view needle_2 = needle_2_;
    text_view needle_3 = needle_3_;
    text_view needle_4 = needle_4_;
    text_view needle_5 = needle_5_;
    text_view needle_6 = needle_6_;
    text_view needle_7 = needle_7_;

    text_view haystack_2 = haystack_2_;
    text_view needle_11 = needle_11_;

    text_view haystack_3 = haystack_3_;
    text_view needle_12 = needle_12_;
    ...
    do_search(table, haystack_1, text_view(), 0, 0, __LINE__);
    do_search(table, text_view(), needle_1, 0, 0, __LINE__);
}
...
TEST(text_view_algorithm, coll_search_danish)
{
    ...
    text_view haystack_2 = haystack_2_;
    text_view haystack_3 = haystack_3_;
    text_view haystack_4 = haystack_4_;
    text_view haystack_5 = haystack_5_;
    text_view needle_1 = needle_1_;
    text_view needle_2 = needle_2_;
    text_view needle_3 = needle_3_;
...
TEST(text_view_algorithm, coll_search_case_accents_and_punct)
{
...
TEST(text_view_algorithm, case_mapping_)
{
    // Taken from case_mapping.cpp case 000.

    // 00DF; 00DF; 0053 0073; 0053 0053; # LATIN SMALL LETTER SHARP S
    text cp_("\xc3\x9f"); // 00DF
    text_view cp = cp_;
    ...
    { // to_title
        text from_("\x61\x61\x61\xc3\x9f");
        text_view from = from_;
