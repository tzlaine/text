...
TEST(tailoring, rules_)";
    string const this_test = string(g_curr_file) + "_" + g_curr_tailoring;
    g_ofs << header << this_test << R"()
{
)";
    ...
    tailored_collation_element_table const table =
        make_tailored_collation_element_table(
            data::)Q"
          << this_tailoring << R"Q(_collation_tailoring(),
            ")Q" << this_tailoring
          << R"Q(_collation_tailoring()", error, warning);
...
{
    string const this_test = string(g_curr_file) + "_" + g_curr_tailoring;
    string const filename = "tailoring_rule_test_" + this_test + ".cpp";
