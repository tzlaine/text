...
TEST(normalization, nfd_010_000)
{
    ...
    // (㉧; ㉧; ㉧; ᄋ; ᄋ; ) CIRCLED HANGUL IEUNG
    {
        ...
        std::array<uint32_t, 1> const dest = {{ 0x3267 }};
...
TEST(normalization, nfd_010_001)
{
    ...
    // (㉨; ㉨; ㉨; ᄌ; ᄌ; ) CIRCLED HANGUL CIEUC
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3268 }};
...
TEST(normalization, nfd_010_002)
{
    ...
    // (㉩; ㉩; ㉩; ᄎ; ᄎ; ) CIRCLED HANGUL CHIEUCH
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3269 }};
...
TEST(normalization, nfd_010_003)
{
    ...
    // (㉪; ㉪; ㉪; ᄏ; ᄏ; ) CIRCLED HANGUL KHIEUKH
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x326A }};
...
TEST(normalization, nfd_010_004)
{
    ...
    // (㉫; ㉫; ㉫; ᄐ; ᄐ; ) CIRCLED HANGUL THIEUTH
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x326B }};
...
TEST(normalization, nfd_010_005)
{
    ...
    // (㉬; ㉬; ㉬; ᄑ; ᄑ; ) CIRCLED HANGUL PHIEUPH
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x326C }};
...
TEST(normalization, nfd_010_006)
{
    ...
    // (㉭; ㉭; ㉭; ᄒ; ᄒ; ) CIRCLED HANGUL HIEUH
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x326D }};
...
TEST(normalization, nfd_010_007)
{
    ...
    // (㉮; ㉮; ㉮; 가; 가; ) CIRCLED HANGUL KIYEOK A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x326E }};
...
TEST(normalization, nfd_010_008)
{
    ...
    // (㉯; ㉯; ㉯; 나; 나; ) CIRCLED HANGUL NIEUN A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x326F }};
...
TEST(normalization, nfd_010_009)
{
    ...
    // (㉰; ㉰; ㉰; 다; 다; ) CIRCLED HANGUL TIKEUT A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3270 }};
...
TEST(normalization, nfd_010_010)
{
    ...
    // (㉱; ㉱; ㉱; 라; 라; ) CIRCLED HANGUL RIEUL A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3271 }};
...
TEST(normalization, nfd_010_011)
{
    ...
    // (㉲; ㉲; ㉲; 마; 마; ) CIRCLED HANGUL MIEUM A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3272 }};
...
TEST(normalization, nfd_010_012)
{
    ...
    // (㉳; ㉳; ㉳; 바; 바; ) CIRCLED HANGUL PIEUP A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3273 }};
...
TEST(normalization, nfd_010_013)
{
    ...
    // (㉴; ㉴; ㉴; 사; 사; ) CIRCLED HANGUL SIOS A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3274 }};
...
TEST(normalization, nfd_010_014)
{
    ...
    // (㉵; ㉵; ㉵; 아; 아; ) CIRCLED HANGUL IEUNG A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3275 }};
...
TEST(normalization, nfd_010_015)
{
    ...
    // (㉶; ㉶; ㉶; 자; 자; ) CIRCLED HANGUL CIEUC A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3276 }};
...
TEST(normalization, nfd_010_016)
{
    ...
    // (㉷; ㉷; ㉷; 차; 차; ) CIRCLED HANGUL CHIEUCH A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3277 }};
...
TEST(normalization, nfd_010_017)
{
    ...
    // (㉸; ㉸; ㉸; 카; 카; ) CIRCLED HANGUL KHIEUKH A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3278 }};
...
TEST(normalization, nfd_010_018)
{
    ...
    // (㉹; ㉹; ㉹; 타; 타; ) CIRCLED HANGUL THIEUTH A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3279 }};
...
TEST(normalization, nfd_010_019)
{
    ...
    // (㉺; ㉺; ㉺; 파; 파; ) CIRCLED HANGUL PHIEUPH A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x327A }};
...
TEST(normalization, nfd_010_020)
{
    ...
    // (㉻; ㉻; ㉻; 하; 하; ) CIRCLED HANGUL HIEUH A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x327B }};
...
TEST(normalization, nfd_010_021)
{
    ...
    // (㉼; ㉼; ㉼; 참고; 참고; ) CIRCLED KOREAN CHARACTER CHAMKO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x327C }};
...
TEST(normalization, nfd_010_022)
{
    ...
    // (㉽; ㉽; ㉽; 주의; 주의; ) CIRCLED KOREAN CHARACTER JUEUI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x327D }};
...
TEST(normalization, nfd_010_023)
{
    ...
    // (㉾; ㉾; ㉾; 우; 우; ) CIRCLED HANGUL IEUNG U
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x327E }};
...
TEST(normalization, nfd_010_024)
{
    ...
    // (㊀; ㊀; ㊀; 一; 一; ) CIRCLED IDEOGRAPH ONE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3280 }};
...
TEST(normalization, nfd_010_025)
{
    ...
    // (㊁; ㊁; ㊁; 二; 二; ) CIRCLED IDEOGRAPH TWO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3281 }};
...
TEST(normalization, nfd_010_026)
{
    ...
    // (㊂; ㊂; ㊂; 三; 三; ) CIRCLED IDEOGRAPH THREE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3282 }};
...
TEST(normalization, nfd_010_027)
{
    ...
    // (㊃; ㊃; ㊃; 四; 四; ) CIRCLED IDEOGRAPH FOUR
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3283 }};
...
TEST(normalization, nfd_010_028)
{
    ...
    // (㊄; ㊄; ㊄; 五; 五; ) CIRCLED IDEOGRAPH FIVE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3284 }};
...
TEST(normalization, nfd_010_029)
{
    ...
    // (㊅; ㊅; ㊅; 六; 六; ) CIRCLED IDEOGRAPH SIX
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3285 }};
...
TEST(normalization, nfd_010_030)
{
    ...
    // (㊆; ㊆; ㊆; 七; 七; ) CIRCLED IDEOGRAPH SEVEN
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3286 }};
...
TEST(normalization, nfd_010_031)
{
    ...
    // (㊇; ㊇; ㊇; 八; 八; ) CIRCLED IDEOGRAPH EIGHT
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3287 }};
...
TEST(normalization, nfd_010_032)
{
    ...
    // (㊈; ㊈; ㊈; 九; 九; ) CIRCLED IDEOGRAPH NINE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3288 }};
...
TEST(normalization, nfd_010_033)
{
    ...
    // (㊉; ㊉; ㊉; 十; 十; ) CIRCLED IDEOGRAPH TEN
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3289 }};
...
TEST(normalization, nfd_010_034)
{
    ...
    // (㊊; ㊊; ㊊; 月; 月; ) CIRCLED IDEOGRAPH MOON
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x328A }};
...
TEST(normalization, nfd_010_035)
{
    ...
    // (㊋; ㊋; ㊋; 火; 火; ) CIRCLED IDEOGRAPH FIRE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x328B }};
...
TEST(normalization, nfd_010_036)
{
    ...
    // (㊌; ㊌; ㊌; 水; 水; ) CIRCLED IDEOGRAPH WATER
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x328C }};
...
TEST(normalization, nfd_010_037)
{
    ...
    // (㊍; ㊍; ㊍; 木; 木; ) CIRCLED IDEOGRAPH WOOD
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x328D }};
...
TEST(normalization, nfd_010_038)
{
    ...
    // (㊎; ㊎; ㊎; 金; 金; ) CIRCLED IDEOGRAPH METAL
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x328E }};
...
TEST(normalization, nfd_010_039)
{
    ...
    // (㊏; ㊏; ㊏; 土; 土; ) CIRCLED IDEOGRAPH EARTH
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x328F }};
...
TEST(normalization, nfd_010_040)
{
    ...
    // (㊐; ㊐; ㊐; 日; 日; ) CIRCLED IDEOGRAPH SUN
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3290 }};
...
TEST(normalization, nfd_010_041)
{
    ...
    // (㊑; ㊑; ㊑; 株; 株; ) CIRCLED IDEOGRAPH STOCK
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3291 }};
...
TEST(normalization, nfd_010_042)
{
    ...
    // (㊒; ㊒; ㊒; 有; 有; ) CIRCLED IDEOGRAPH HAVE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3292 }};
...
TEST(normalization, nfd_010_043)
{
    ...
    // (㊓; ㊓; ㊓; 社; 社; ) CIRCLED IDEOGRAPH SOCIETY
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3293 }};
...
TEST(normalization, nfd_010_044)
{
    ...
    // (㊔; ㊔; ㊔; 名; 名; ) CIRCLED IDEOGRAPH NAME
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3294 }};
...
TEST(normalization, nfd_010_045)
{
    ...
    // (㊕; ㊕; ㊕; 特; 特; ) CIRCLED IDEOGRAPH SPECIAL
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3295 }};
...
TEST(normalization, nfd_010_046)
{
    ...
    // (㊖; ㊖; ㊖; 財; 財; ) CIRCLED IDEOGRAPH FINANCIAL
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3296 }};
...
TEST(normalization, nfd_010_047)
{
    ...
    // (㊗; ㊗; ㊗; 祝; 祝; ) CIRCLED IDEOGRAPH CONGRATULATION
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3297 }};
...
TEST(normalization, nfd_010_048)
{
    ...
    // (㊘; ㊘; ㊘; 労; 労; ) CIRCLED IDEOGRAPH LABOR
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3298 }};
...
TEST(normalization, nfd_010_049)
{
    ...
    // (㊙; ㊙; ㊙; 秘; 秘; ) CIRCLED IDEOGRAPH SECRET
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3299 }};
...
TEST(normalization, nfd_010_050)
{
    ...
    // (㊚; ㊚; ㊚; 男; 男; ) CIRCLED IDEOGRAPH MALE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x329A }};
...
TEST(normalization, nfd_010_051)
{
    ...
    // (㊛; ㊛; ㊛; 女; 女; ) CIRCLED IDEOGRAPH FEMALE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x329B }};
...
TEST(normalization, nfd_010_052)
{
    ...
    // (㊜; ㊜; ㊜; 適; 適; ) CIRCLED IDEOGRAPH SUITABLE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x329C }};
...
TEST(normalization, nfd_010_053)
{
    ...
    // (㊝; ㊝; ㊝; 優; 優; ) CIRCLED IDEOGRAPH EXCELLENT
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x329D }};
...
TEST(normalization, nfd_010_054)
{
    ...
    // (㊞; ㊞; ㊞; 印; 印; ) CIRCLED IDEOGRAPH PRINT
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x329E }};
...
TEST(normalization, nfd_010_055)
{
    ...
    // (㊟; ㊟; ㊟; 注; 注; ) CIRCLED IDEOGRAPH ATTENTION
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x329F }};
...
TEST(normalization, nfd_010_056)
{
    ...
    // (㊠; ㊠; ㊠; 項; 項; ) CIRCLED IDEOGRAPH ITEM
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32A0 }};
...
TEST(normalization, nfd_010_057)
{
    ...
    // (㊡; ㊡; ㊡; 休; 休; ) CIRCLED IDEOGRAPH REST
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32A1 }};
...
TEST(normalization, nfd_010_058)
{
    ...
    // (㊢; ㊢; ㊢; 写; 写; ) CIRCLED IDEOGRAPH COPY
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32A2 }};
...
TEST(normalization, nfd_010_059)
{
    ...
    // (㊣; ㊣; ㊣; 正; 正; ) CIRCLED IDEOGRAPH CORRECT
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32A3 }};
...
TEST(normalization, nfd_010_060)
{
    ...
    // (㊤; ㊤; ㊤; 上; 上; ) CIRCLED IDEOGRAPH HIGH
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32A4 }};
...
TEST(normalization, nfd_010_061)
{
    ...
    // (㊥; ㊥; ㊥; 中; 中; ) CIRCLED IDEOGRAPH CENTRE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32A5 }};
...
TEST(normalization, nfd_010_062)
{
    ...
    // (㊦; ㊦; ㊦; 下; 下; ) CIRCLED IDEOGRAPH LOW
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32A6 }};
...
TEST(normalization, nfd_010_063)
{
    ...
    // (㊧; ㊧; ㊧; 左; 左; ) CIRCLED IDEOGRAPH LEFT
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32A7 }};
...
TEST(normalization, nfd_010_064)
{
    ...
    // (㊨; ㊨; ㊨; 右; 右; ) CIRCLED IDEOGRAPH RIGHT
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32A8 }};
...
TEST(normalization, nfd_010_065)
{
    ...
    // (㊩; ㊩; ㊩; 医; 医; ) CIRCLED IDEOGRAPH MEDICINE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32A9 }};
...
TEST(normalization, nfd_010_066)
{
    ...
    // (㊪; ㊪; ㊪; 宗; 宗; ) CIRCLED IDEOGRAPH RELIGION
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32AA }};
...
TEST(normalization, nfd_010_067)
{
    ...
    // (㊫; ㊫; ㊫; 学; 学; ) CIRCLED IDEOGRAPH STUDY
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32AB }};
...
TEST(normalization, nfd_010_068)
{
    ...
    // (㊬; ㊬; ㊬; 監; 監; ) CIRCLED IDEOGRAPH SUPERVISE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32AC }};
...
TEST(normalization, nfd_010_069)
{
    ...
    // (㊭; ㊭; ㊭; 企; 企; ) CIRCLED IDEOGRAPH ENTERPRISE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32AD }};
...
TEST(normalization, nfd_010_070)
{
    ...
    // (㊮; ㊮; ㊮; 資; 資; ) CIRCLED IDEOGRAPH RESOURCE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32AE }};
...
TEST(normalization, nfd_010_071)
{
    ...
    // (㊯; ㊯; ㊯; 協; 協; ) CIRCLED IDEOGRAPH ALLIANCE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32AF }};
...
TEST(normalization, nfd_010_072)
{
    ...
    // (㊰; ㊰; ㊰; 夜; 夜; ) CIRCLED IDEOGRAPH NIGHT
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32B0 }};
...
TEST(normalization, nfd_010_073)
{
    ...
    // (㊱; ㊱; ㊱; 36; 36; ) CIRCLED NUMBER THIRTY SIX
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32B1 }};
...
TEST(normalization, nfd_010_074)
{
    ...
    // (㊲; ㊲; ㊲; 37; 37; ) CIRCLED NUMBER THIRTY SEVEN
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32B2 }};
...
TEST(normalization, nfd_010_075)
{
    ...
    // (㊳; ㊳; ㊳; 38; 38; ) CIRCLED NUMBER THIRTY EIGHT
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32B3 }};
...
TEST(normalization, nfd_010_076)
{
    ...
    // (㊴; ㊴; ㊴; 39; 39; ) CIRCLED NUMBER THIRTY NINE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32B4 }};
...
TEST(normalization, nfd_010_077)
{
    ...
    // (㊵; ㊵; ㊵; 40; 40; ) CIRCLED NUMBER FORTY
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32B5 }};
...
TEST(normalization, nfd_010_078)
{
    ...
    // (㊶; ㊶; ㊶; 41; 41; ) CIRCLED NUMBER FORTY ONE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32B6 }};
...
TEST(normalization, nfd_010_079)
{
    ...
    // (㊷; ㊷; ㊷; 42; 42; ) CIRCLED NUMBER FORTY TWO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32B7 }};
...
TEST(normalization, nfd_010_080)
{
    ...
    // (㊸; ㊸; ㊸; 43; 43; ) CIRCLED NUMBER FORTY THREE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32B8 }};
...
TEST(normalization, nfd_010_081)
{
    ...
    // (㊹; ㊹; ㊹; 44; 44; ) CIRCLED NUMBER FORTY FOUR
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32B9 }};
...
TEST(normalization, nfd_010_082)
{
    ...
    // (㊺; ㊺; ㊺; 45; 45; ) CIRCLED NUMBER FORTY FIVE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32BA }};
...
TEST(normalization, nfd_010_083)
{
    ...
    // (㊻; ㊻; ㊻; 46; 46; ) CIRCLED NUMBER FORTY SIX
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32BB }};
...
TEST(normalization, nfd_010_084)
{
    ...
    // (㊼; ㊼; ㊼; 47; 47; ) CIRCLED NUMBER FORTY SEVEN
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32BC }};
...
TEST(normalization, nfd_010_085)
{
    ...
    // (㊽; ㊽; ㊽; 48; 48; ) CIRCLED NUMBER FORTY EIGHT
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32BD }};
...
TEST(normalization, nfd_010_086)
{
    ...
    // (㊾; ㊾; ㊾; 49; 49; ) CIRCLED NUMBER FORTY NINE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32BE }};
...
TEST(normalization, nfd_010_087)
{
    ...
    // (㊿; ㊿; ㊿; 50; 50; ) CIRCLED NUMBER FIFTY
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32BF }};
...
TEST(normalization, nfd_010_088)
{
    ...
    // (㋀; ㋀; ㋀; 1月; 1月; ) IDEOGRAPHIC TELEGRAPH SYMBOL FOR JANUARY
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32C0 }};
...
TEST(normalization, nfd_010_089)
{
    ...
    // (㋁; ㋁; ㋁; 2月; 2月; ) IDEOGRAPHIC TELEGRAPH SYMBOL FOR FEBRUARY
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32C1 }};
...
TEST(normalization, nfd_010_090)
{
    ...
    // (㋂; ㋂; ㋂; 3月; 3月; ) IDEOGRAPHIC TELEGRAPH SYMBOL FOR MARCH
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32C2 }};
...
TEST(normalization, nfd_010_091)
{
    ...
    // (㋃; ㋃; ㋃; 4月; 4月; ) IDEOGRAPHIC TELEGRAPH SYMBOL FOR APRIL
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32C3 }};
...
TEST(normalization, nfd_010_092)
{
    ...
    // (㋄; ㋄; ㋄; 5月; 5月; ) IDEOGRAPHIC TELEGRAPH SYMBOL FOR MAY
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32C4 }};
...
TEST(normalization, nfd_010_093)
{
    ...
    // (㋅; ㋅; ㋅; 6月; 6月; ) IDEOGRAPHIC TELEGRAPH SYMBOL FOR JUNE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32C5 }};
...
TEST(normalization, nfd_010_094)
{
    ...
    // (㋆; ㋆; ㋆; 7月; 7月; ) IDEOGRAPHIC TELEGRAPH SYMBOL FOR JULY
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32C6 }};
...
TEST(normalization, nfd_010_095)
{
    ...
    // (㋇; ㋇; ㋇; 8月; 8月; ) IDEOGRAPHIC TELEGRAPH SYMBOL FOR AUGUST
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32C7 }};
...
TEST(normalization, nfd_010_096)
{
    ...
    // (㋈; ㋈; ㋈; 9月; 9月; ) IDEOGRAPHIC TELEGRAPH SYMBOL FOR SEPTEMBER
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32C8 }};
...
TEST(normalization, nfd_010_097)
{
    ...
    // (㋉; ㋉; ㋉; 10月; 10月; ) IDEOGRAPHIC TELEGRAPH SYMBOL FOR OCTOBER
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32C9 }};
...
TEST(normalization, nfd_010_098)
{
    ...
    // (㋊; ㋊; ㋊; 11月; 11月; ) IDEOGRAPHIC TELEGRAPH SYMBOL FOR NOVEMBER
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32CA }};
...
TEST(normalization, nfd_010_099)
{
    ...
    // (㋋; ㋋; ㋋; 12月; 12月; ) IDEOGRAPHIC TELEGRAPH SYMBOL FOR DECEMBER
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32CB }};
...
TEST(normalization, nfd_010_100)
{
    ...
    // (㋌; ㋌; ㋌; Hg; Hg; ) SQUARE HG
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32CC }};
...
TEST(normalization, nfd_010_101)
{
    ...
    // (㋍; ㋍; ㋍; erg; erg; ) SQUARE ERG
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32CD }};
...
TEST(normalization, nfd_010_102)
{
    ...
    // (㋎; ㋎; ㋎; eV; eV; ) SQUARE EV
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32CE }};
...
TEST(normalization, nfd_010_103)
{
    ...
    // (㋏; ㋏; ㋏; LTD; LTD; ) LIMITED LIABILITY SIGN
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32CF }};
...
TEST(normalization, nfd_010_104)
{
    ...
    // (㋐; ㋐; ㋐; ア; ア; ) CIRCLED KATAKANA A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32D0 }};
...
TEST(normalization, nfd_010_105)
{
    ...
    // (㋑; ㋑; ㋑; イ; イ; ) CIRCLED KATAKANA I
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32D1 }};
...
TEST(normalization, nfd_010_106)
{
    ...
    // (㋒; ㋒; ㋒; ウ; ウ; ) CIRCLED KATAKANA U
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32D2 }};
...
TEST(normalization, nfd_010_107)
{
    ...
    // (㋓; ㋓; ㋓; エ; エ; ) CIRCLED KATAKANA E
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32D3 }};
...
TEST(normalization, nfd_010_108)
{
    ...
    // (㋔; ㋔; ㋔; オ; オ; ) CIRCLED KATAKANA O
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32D4 }};
...
TEST(normalization, nfd_010_109)
{
    ...
    // (㋕; ㋕; ㋕; カ; カ; ) CIRCLED KATAKANA KA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32D5 }};
...
TEST(normalization, nfd_010_110)
{
    ...
    // (㋖; ㋖; ㋖; キ; キ; ) CIRCLED KATAKANA KI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32D6 }};
...
TEST(normalization, nfd_010_111)
{
    ...
    // (㋗; ㋗; ㋗; ク; ク; ) CIRCLED KATAKANA KU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32D7 }};
...
TEST(normalization, nfd_010_112)
{
    ...
    // (㋘; ㋘; ㋘; ケ; ケ; ) CIRCLED KATAKANA KE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32D8 }};
...
TEST(normalization, nfd_010_113)
{
    ...
    // (㋙; ㋙; ㋙; コ; コ; ) CIRCLED KATAKANA KO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32D9 }};
...
TEST(normalization, nfd_010_114)
{
    ...
    // (㋚; ㋚; ㋚; サ; サ; ) CIRCLED KATAKANA SA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32DA }};
...
TEST(normalization, nfd_010_115)
{
    ...
    // (㋛; ㋛; ㋛; シ; シ; ) CIRCLED KATAKANA SI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32DB }};
...
TEST(normalization, nfd_010_116)
{
    ...
    // (㋜; ㋜; ㋜; ス; ス; ) CIRCLED KATAKANA SU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32DC }};
...
TEST(normalization, nfd_010_117)
{
    ...
    // (㋝; ㋝; ㋝; セ; セ; ) CIRCLED KATAKANA SE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32DD }};
...
TEST(normalization, nfd_010_118)
{
    ...
    // (㋞; ㋞; ㋞; ソ; ソ; ) CIRCLED KATAKANA SO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32DE }};
...
TEST(normalization, nfd_010_119)
{
    ...
    // (㋟; ㋟; ㋟; タ; タ; ) CIRCLED KATAKANA TA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32DF }};
...
TEST(normalization, nfd_010_120)
{
    ...
    // (㋠; ㋠; ㋠; チ; チ; ) CIRCLED KATAKANA TI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32E0 }};
...
TEST(normalization, nfd_010_121)
{
    ...
    // (㋡; ㋡; ㋡; ツ; ツ; ) CIRCLED KATAKANA TU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32E1 }};
...
TEST(normalization, nfd_010_122)
{
    ...
    // (㋢; ㋢; ㋢; テ; テ; ) CIRCLED KATAKANA TE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32E2 }};
...
TEST(normalization, nfd_010_123)
{
    ...
    // (㋣; ㋣; ㋣; ト; ト; ) CIRCLED KATAKANA TO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32E3 }};
...
TEST(normalization, nfd_010_124)
{
    ...
    // (㋤; ㋤; ㋤; ナ; ナ; ) CIRCLED KATAKANA NA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32E4 }};
...
TEST(normalization, nfd_010_125)
{
    ...
    // (㋥; ㋥; ㋥; ニ; ニ; ) CIRCLED KATAKANA NI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32E5 }};
...
TEST(normalization, nfd_010_126)
{
    ...
    // (㋦; ㋦; ㋦; ヌ; ヌ; ) CIRCLED KATAKANA NU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32E6 }};
...
TEST(normalization, nfd_010_127)
{
    ...
    // (㋧; ㋧; ㋧; ネ; ネ; ) CIRCLED KATAKANA NE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32E7 }};
...
TEST(normalization, nfd_010_128)
{
    ...
    // (㋨; ㋨; ㋨; ノ; ノ; ) CIRCLED KATAKANA NO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32E8 }};
...
TEST(normalization, nfd_010_129)
{
    ...
    // (㋩; ㋩; ㋩; ハ; ハ; ) CIRCLED KATAKANA HA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32E9 }};
...
TEST(normalization, nfd_010_130)
{
    ...
    // (㋪; ㋪; ㋪; ヒ; ヒ; ) CIRCLED KATAKANA HI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32EA }};
...
TEST(normalization, nfd_010_131)
{
    ...
    // (㋫; ㋫; ㋫; フ; フ; ) CIRCLED KATAKANA HU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32EB }};
...
TEST(normalization, nfd_010_132)
{
    ...
    // (㋬; ㋬; ㋬; ヘ; ヘ; ) CIRCLED KATAKANA HE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32EC }};
...
TEST(normalization, nfd_010_133)
{
    ...
    // (㋭; ㋭; ㋭; ホ; ホ; ) CIRCLED KATAKANA HO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32ED }};
...
TEST(normalization, nfd_010_134)
{
    ...
    // (㋮; ㋮; ㋮; マ; マ; ) CIRCLED KATAKANA MA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32EE }};
...
TEST(normalization, nfd_010_135)
{
    ...
    // (㋯; ㋯; ㋯; ミ; ミ; ) CIRCLED KATAKANA MI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32EF }};
...
TEST(normalization, nfd_010_136)
{
    ...
    // (㋰; ㋰; ㋰; ム; ム; ) CIRCLED KATAKANA MU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32F0 }};
...
TEST(normalization, nfd_010_137)
{
    ...
    // (㋱; ㋱; ㋱; メ; メ; ) CIRCLED KATAKANA ME
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32F1 }};
...
TEST(normalization, nfd_010_138)
{
    ...
    // (㋲; ㋲; ㋲; モ; モ; ) CIRCLED KATAKANA MO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32F2 }};
...
TEST(normalization, nfd_010_139)
{
    ...
    // (㋳; ㋳; ㋳; ヤ; ヤ; ) CIRCLED KATAKANA YA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32F3 }};
...
TEST(normalization, nfd_010_140)
{
    ...
    // (㋴; ㋴; ㋴; ユ; ユ; ) CIRCLED KATAKANA YU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32F4 }};
...
TEST(normalization, nfd_010_141)
{
    ...
    // (㋵; ㋵; ㋵; ヨ; ヨ; ) CIRCLED KATAKANA YO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32F5 }};
...
TEST(normalization, nfd_010_142)
{
    ...
    // (㋶; ㋶; ㋶; ラ; ラ; ) CIRCLED KATAKANA RA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32F6 }};
...
TEST(normalization, nfd_010_143)
{
    ...
    // (㋷; ㋷; ㋷; リ; リ; ) CIRCLED KATAKANA RI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32F7 }};
...
TEST(normalization, nfd_010_144)
{
    ...
    // (㋸; ㋸; ㋸; ル; ル; ) CIRCLED KATAKANA RU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32F8 }};
...
TEST(normalization, nfd_010_145)
{
    ...
    // (㋹; ㋹; ㋹; レ; レ; ) CIRCLED KATAKANA RE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32F9 }};
...
TEST(normalization, nfd_010_146)
{
    ...
    // (㋺; ㋺; ㋺; ロ; ロ; ) CIRCLED KATAKANA RO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32FA }};
...
TEST(normalization, nfd_010_147)
{
    ...
    // (㋻; ㋻; ㋻; ワ; ワ; ) CIRCLED KATAKANA WA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32FB }};
...
TEST(normalization, nfd_010_148)
{
    ...
    // (㋼; ㋼; ㋼; ヰ; ヰ; ) CIRCLED KATAKANA WI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32FC }};
...
TEST(normalization, nfd_010_149)
{
    ...
    // (㋽; ㋽; ㋽; ヱ; ヱ; ) CIRCLED KATAKANA WE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32FD }};
...
TEST(normalization, nfd_010_150)
{
    ...
    // (㋾; ㋾; ㋾; ヲ; ヲ; ) CIRCLED KATAKANA WO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x32FE }};
...
TEST(normalization, nfd_010_151)
{
    ...
    // (㌀; ㌀; ㌀; アパート; アハ◌゚ート; ) SQUARE APAATO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3300 }};
...
TEST(normalization, nfd_010_152)
{
    ...
    // (㌁; ㌁; ㌁; アルファ; アルファ; ) SQUARE ARUHUA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3301 }};
...
TEST(normalization, nfd_010_153)
{
    ...
    // (㌂; ㌂; ㌂; アンペア; アンヘ◌゚ア; ) SQUARE ANPEA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3302 }};
...
TEST(normalization, nfd_010_154)
{
    ...
    // (㌃; ㌃; ㌃; アール; アール; ) SQUARE AARU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3303 }};
...
TEST(normalization, nfd_010_155)
{
    ...
    // (㌄; ㌄; ㌄; イニング; イニンク◌゙; ) SQUARE ININGU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3304 }};
...
TEST(normalization, nfd_010_156)
{
    ...
    // (㌅; ㌅; ㌅; インチ; インチ; ) SQUARE INTI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3305 }};
...
TEST(normalization, nfd_010_157)
{
    ...
    // (㌆; ㌆; ㌆; ウォン; ウォン; ) SQUARE UON
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3306 }};
...
TEST(normalization, nfd_010_158)
{
    ...
    // (㌇; ㌇; ㌇; エスクード; エスクート◌゙; ) SQUARE ESUKUUDO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3307 }};
...
TEST(normalization, nfd_010_159)
{
    ...
    // (㌈; ㌈; ㌈; エーカー; エーカー; ) SQUARE EEKAA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3308 }};
...
TEST(normalization, nfd_010_160)
{
    ...
    // (㌉; ㌉; ㌉; オンス; オンス; ) SQUARE ONSU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3309 }};
...
TEST(normalization, nfd_010_161)
{
    ...
    // (㌊; ㌊; ㌊; オーム; オーム; ) SQUARE OOMU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x330A }};
...
TEST(normalization, nfd_010_162)
{
    ...
    // (㌋; ㌋; ㌋; カイリ; カイリ; ) SQUARE KAIRI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x330B }};
...
TEST(normalization, nfd_010_163)
{
    ...
    // (㌌; ㌌; ㌌; カラット; カラット; ) SQUARE KARATTO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x330C }};
...
TEST(normalization, nfd_010_164)
{
    ...
    // (㌍; ㌍; ㌍; カロリー; カロリー; ) SQUARE KARORII
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x330D }};
...
TEST(normalization, nfd_010_165)
{
    ...
    // (㌎; ㌎; ㌎; ガロン; カ◌゙ロン; ) SQUARE GARON
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x330E }};
...
TEST(normalization, nfd_010_166)
{
    ...
    // (㌏; ㌏; ㌏; ガンマ; カ◌゙ンマ; ) SQUARE GANMA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x330F }};
...
TEST(normalization, nfd_010_167)
{
    ...
    // (㌐; ㌐; ㌐; ギガ; キ◌゙カ◌゙; ) SQUARE GIGA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3310 }};
...
TEST(normalization, nfd_010_168)
{
    ...
    // (㌑; ㌑; ㌑; ギニー; キ◌゙ニー; ) SQUARE GINII
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3311 }};
...
TEST(normalization, nfd_010_169)
{
    ...
    // (㌒; ㌒; ㌒; キュリー; キュリー; ) SQUARE KYURII
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3312 }};
...
TEST(normalization, nfd_010_170)
{
    ...
    // (㌓; ㌓; ㌓; ギルダー; キ◌゙ルタ◌゙ー; ) SQUARE GIRUDAA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3313 }};
...
TEST(normalization, nfd_010_171)
{
    ...
    // (㌔; ㌔; ㌔; キロ; キロ; ) SQUARE KIRO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3314 }};
...
TEST(normalization, nfd_010_172)
{
    ...
    // (㌕; ㌕; ㌕; キログラム; キロク◌゙ラム; ) SQUARE KIROGURAMU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3315 }};
...
TEST(normalization, nfd_010_173)
{
    ...
    // (㌖; ㌖; ㌖; キロメートル; キロメートル; ) SQUARE KIROMEETORU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3316 }};
...
TEST(normalization, nfd_010_174)
{
    ...
    // (㌗; ㌗; ㌗; キロワット; キロワット; ) SQUARE KIROWATTO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3317 }};
...
TEST(normalization, nfd_010_175)
{
    ...
    // (㌘; ㌘; ㌘; グラム; ク◌゙ラム; ) SQUARE GURAMU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3318 }};
...
TEST(normalization, nfd_010_176)
{
    ...
    // (㌙; ㌙; ㌙; グラムトン; ク◌゙ラムトン; ) SQUARE GURAMUTON
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3319 }};
...
TEST(normalization, nfd_010_177)
{
    ...
    // (㌚; ㌚; ㌚; クルゼイロ; クルセ◌゙イロ; ) SQUARE KURUZEIRO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x331A }};
...
TEST(normalization, nfd_010_178)
{
    ...
    // (㌛; ㌛; ㌛; クローネ; クローネ; ) SQUARE KUROONE
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x331B }};
...
TEST(normalization, nfd_010_179)
{
    ...
    // (㌜; ㌜; ㌜; ケース; ケース; ) SQUARE KEESU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x331C }};
...
TEST(normalization, nfd_010_180)
{
    ...
    // (㌝; ㌝; ㌝; コルナ; コルナ; ) SQUARE KORUNA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x331D }};
...
TEST(normalization, nfd_010_181)
{
    ...
    // (㌞; ㌞; ㌞; コーポ; コーホ◌゚; ) SQUARE KOOPO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x331E }};
...
TEST(normalization, nfd_010_182)
{
    ...
    // (㌟; ㌟; ㌟; サイクル; サイクル; ) SQUARE SAIKURU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x331F }};
...
TEST(normalization, nfd_010_183)
{
    ...
    // (㌠; ㌠; ㌠; サンチーム; サンチーム; ) SQUARE SANTIIMU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3320 }};
...
TEST(normalization, nfd_010_184)
{
    ...
    // (㌡; ㌡; ㌡; シリング; シリンク◌゙; ) SQUARE SIRINGU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3321 }};
...
TEST(normalization, nfd_010_185)
{
    ...
    // (㌢; ㌢; ㌢; センチ; センチ; ) SQUARE SENTI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3322 }};
...
TEST(normalization, nfd_010_186)
{
    ...
    // (㌣; ㌣; ㌣; セント; セント; ) SQUARE SENTO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3323 }};
...
TEST(normalization, nfd_010_187)
{
    ...
    // (㌤; ㌤; ㌤; ダース; タ◌゙ース; ) SQUARE DAASU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3324 }};
...
TEST(normalization, nfd_010_188)
{
    ...
    // (㌥; ㌥; ㌥; デシ; テ◌゙シ; ) SQUARE DESI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3325 }};
...
TEST(normalization, nfd_010_189)
{
    ...
    // (㌦; ㌦; ㌦; ドル; ト◌゙ル; ) SQUARE DORU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3326 }};
...
TEST(normalization, nfd_010_190)
{
    ...
    // (㌧; ㌧; ㌧; トン; トン; ) SQUARE TON
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3327 }};
...
TEST(normalization, nfd_010_191)
{
    ...
    // (㌨; ㌨; ㌨; ナノ; ナノ; ) SQUARE NANO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3328 }};
...
TEST(normalization, nfd_010_192)
{
    ...
    // (㌩; ㌩; ㌩; ノット; ノット; ) SQUARE NOTTO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3329 }};
...
TEST(normalization, nfd_010_193)
{
    ...
    // (㌪; ㌪; ㌪; ハイツ; ハイツ; ) SQUARE HAITU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x332A }};
...
TEST(normalization, nfd_010_194)
{
    ...
    // (㌫; ㌫; ㌫; パーセント; ハ◌゚ーセント; ) SQUARE PAASENTO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x332B }};
...
TEST(normalization, nfd_010_195)
{
    ...
    // (㌬; ㌬; ㌬; パーツ; ハ◌゚ーツ; ) SQUARE PAATU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x332C }};
...
TEST(normalization, nfd_010_196)
{
    ...
    // (㌭; ㌭; ㌭; バーレル; ハ◌゙ーレル; ) SQUARE BAARERU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x332D }};
...
TEST(normalization, nfd_010_197)
{
    ...
    // (㌮; ㌮; ㌮; ピアストル; ヒ◌゚アストル; ) SQUARE PIASUTORU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x332E }};
...
TEST(normalization, nfd_010_198)
{
    ...
    // (㌯; ㌯; ㌯; ピクル; ヒ◌゚クル; ) SQUARE PIKURU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x332F }};
...
TEST(normalization, nfd_010_199)
{
    ...
    // (㌰; ㌰; ㌰; ピコ; ヒ◌゚コ; ) SQUARE PIKO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0x3330 }};
