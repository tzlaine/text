...
TEST(rope, test_collation)
{
    ...
    {
        text::basic_rope<text::nf::c> nfc("rôle");
        text::basic_rope<text::nf::d> nfd("rôle");
        EXPECT_EQ(
            text::collation_sort_key(nfc, table),
            text::collation_sort_key(nfd, table));
    }
    {
        text::basic_rope<text::nf::d> lhs("role");
        text::basic_rope<text::nf::d> rhs("rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c> lhs("role");
        text::basic_rope<text::nf::d> rhs("rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::d> lhs("role");
        text::basic_rope<text::nf::c> rhs("rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c> lhs("role");
...
TEST(rope, test_collation_utf16)
{
    ...
    {
        text::basic_rope<text::nf::c, char16_t> nfc(u"rôle");
        text::basic_rope<text::nf::d, char> nfd("rôle");
        EXPECT_EQ(
            text::collation_sort_key(nfc, table),
            text::collation_sort_key(nfd, table));
    }
    {
        text::basic_rope<text::nf::d, char16_t> lhs(u"role");
        text::basic_rope<text::nf::d, char> rhs("rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c, char16_t> lhs(u"role");
    ...
    {
        text::basic_rope<text::nf::d, char16_t> lhs(u"role");
        text::basic_rope<text::nf::c, char> rhs("rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c, char16_t> lhs(u"role");
    ...
    {
        text::basic_rope<text::nf::c, char> nfc("rôle");
        text::basic_rope<text::nf::d, char16_t> nfd(u"rôle");
        EXPECT_EQ(
            text::collation_sort_key(nfc, table),
            text::collation_sort_key(nfd, table));
    ...
    {
        text::basic_rope<text::nf::d, char> lhs("role");
        text::basic_rope<text::nf::d, char16_t> rhs(u"rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c, char> lhs("role");
        text::basic_rope<text::nf::d, char16_t> rhs(u"rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
...
TEST(rope, test_view_collation)
{
    ...
    {
        text::basic_rope<text::nf::c> nfc_("rôle");
        text::basic_rope<text::nf::d> nfd_("rôle");
    ...
    {
        text::basic_rope<text::nf::d> lhs_("role");
        text::basic_rope<text::nf::d> rhs_("rôle");
        text::basic_rope_view<text::nf::d> lhs(lhs_);
        text::basic_rope_view<text::nf::d> rhs(rhs_);
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c> lhs_("role");
        text::basic_rope<text::nf::d> rhs_("rôle");
    ...
    {
        text::basic_rope<text::nf::d> lhs_("role");
        text::basic_rope<text::nf::c> rhs_("rôle");
        text::basic_rope_view<text::nf::d> lhs(lhs_);
...
TEST(rope, test_view_collation_utf16)
{
    ...
    {
        text::basic_rope<text::nf::c, char16_t> nfc_(u"rôle");
        text::basic_rope<text::nf::d, char> nfd_("rôle");
        text::basic_rope_view<text::nf::c, char16_t> nfc(nfc_);
    ...
    {
        text::basic_rope<text::nf::d, char16_t> lhs_(u"role");
        text::basic_rope<text::nf::d, char> rhs_("rôle");
        text::basic_rope_view<text::nf::d, char16_t> lhs(lhs_);
    ...
    {
        text::basic_rope<text::nf::d, char16_t> lhs_(u"role");
        text::basic_rope<text::nf::c, char> rhs_("rôle");
        text::basic_rope_view<text::nf::d, char16_t> lhs(lhs_);
    ...
    {
        text::basic_rope<text::nf::c, char> nfc_("rôle");
        text::basic_rope<text::nf::d, char16_t> nfd_(u"rôle");
    ...
    {
        text::basic_rope<text::nf::d, char> lhs_("role");
        text::basic_rope<text::nf::d, char16_t> rhs_(u"rôle");
    ...
    {
        text::basic_rope<text::nf::c, char> lhs_("role");
        text::basic_rope<text::nf::d, char16_t> rhs_(u"rôle");
