...
TEST(rope, test_collation)
{
    ...
    {
        text::basic_rope<text::nf::c> nfc((char const *)u8"rôle");
        text::basic_rope<text::nf::d> nfd((char const *)u8"rôle");
        EXPECT_EQ(
            text::collation_sort_key(nfc, table),
            text::collation_sort_key(nfd, table));
    }
    {
        text::basic_rope<text::nf::d> lhs((char const *)u8"role");
        text::basic_rope<text::nf::d> rhs((char const *)u8"rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c> lhs((char const *)u8"role");
        text::basic_rope<text::nf::d> rhs((char const *)u8"rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::d> lhs((char const *)u8"role");
        text::basic_rope<text::nf::c> rhs((char const *)u8"rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c> lhs((char const *)u8"role");
...
TEST(rope, test_collation_utf16)
{
    auto const table = text::default_collation_table();

    {
        text::basic_rope<text::nf::c, char16_t> nfc(u"rôle");
        text::basic_rope<text::nf::d, char16_t> nfd(u"rôle");
        EXPECT_EQ(
            text::collation_sort_key(nfc, table),
            text::collation_sort_key(nfd, table));
    }
    {
        text::basic_rope<text::nf::d, char16_t> lhs(u"role");
        text::basic_rope<text::nf::d, char16_t> rhs(u"rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c, char16_t> lhs(u"role");
        text::basic_rope<text::nf::d, char16_t> rhs(u"rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::d, char16_t> lhs(u"role");
        text::basic_rope<text::nf::c, char16_t> rhs(u"rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c, char16_t> lhs(u"role");
    ...
    {
        text::basic_rope<text::nf::c, char16_t> nfc(u"rôle");
        text::basic_rope<text::nf::d, char> nfd((char const *)u8"rôle");
        EXPECT_EQ(
            text::collation_sort_key(nfc, table),
            text::collation_sort_key(nfd, table));
    }
    {
        text::basic_rope<text::nf::d, char16_t> lhs(u"role");
        text::basic_rope<text::nf::d, char> rhs((char const *)u8"rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c, char16_t> lhs(u"role");
    ...
    {
        text::basic_rope<text::nf::d, char16_t> lhs(u"role");
        text::basic_rope<text::nf::c, char> rhs((char const *)u8"rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c, char16_t> lhs(u"role");
    ...
    {
        text::basic_rope<text::nf::c, char> nfc((char const *)u8"rôle");
        text::basic_rope<text::nf::d, char16_t> nfd(u"rôle");
        EXPECT_EQ(
            text::collation_sort_key(nfc, table),
            text::collation_sort_key(nfd, table));
    ...
    {
        text::basic_rope<text::nf::d, char> lhs((char const *)u8"role");
        text::basic_rope<text::nf::d, char16_t> rhs(u"rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c, char> lhs((char const *)u8"role");
        text::basic_rope<text::nf::d, char16_t> rhs(u"rôle");
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
...
TEST(rope, test_view_collation)
{
    auto const table = text::default_collation_table();

    {
        text::basic_rope<text::nf::c> nfc_((char const *)u8"rôle");
        text::basic_rope<text::nf::d> nfd_((char const *)u8"rôle");
        text::basic_rope_view<text::nf::c> nfc(nfc_);
        text::basic_rope_view<text::nf::d> nfd(nfd_);
        EXPECT_EQ(
            text::collation_sort_key(nfc, table),
            text::collation_sort_key(nfd, table));
    }
    {
        text::basic_rope<text::nf::d> lhs_((char const *)u8"role");
        text::basic_rope<text::nf::d> rhs_((char const *)u8"rôle");
        text::basic_rope_view<text::nf::d> lhs(lhs_);
        text::basic_rope_view<text::nf::d> rhs(rhs_);
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c> lhs_((char const *)u8"role");
        text::basic_rope<text::nf::d> rhs_((char const *)u8"rôle");
        text::basic_rope_view<text::nf::c> lhs(lhs_);
        text::basic_rope_view<text::nf::d> rhs(rhs_);
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::d> lhs_((char const *)u8"role");
        text::basic_rope<text::nf::c> rhs_((char const *)u8"rôle");
        text::basic_rope_view<text::nf::d> lhs(lhs_);
        text::basic_rope_view<text::nf::c> rhs(rhs_);
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c> lhs_((char const *)u8"role");
...
TEST(rope, test_view_collation_utf16)
{
    auto const table = text::default_collation_table();

    {
        text::basic_rope<text::nf::c, char16_t> nfc_(u"rôle");
        text::basic_rope<text::nf::d, char16_t> nfd_(u"rôle");
        text::basic_rope_view<text::nf::c, char16_t> nfc(nfc_);
        text::basic_rope_view<text::nf::d, char16_t> nfd(nfd_);
        EXPECT_EQ(
            text::collation_sort_key(nfc, table),
            text::collation_sort_key(nfd, table));
    }
    {
        text::basic_rope<text::nf::d, char16_t> lhs_(u"role");
        text::basic_rope<text::nf::d, char16_t> rhs_(u"rôle");
        text::basic_rope_view<text::nf::d, char16_t> lhs(lhs_);
        text::basic_rope_view<text::nf::d, char16_t> rhs(rhs_);
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c, char16_t> lhs_(u"role");
        text::basic_rope<text::nf::d, char16_t> rhs_(u"rôle");
        text::basic_rope_view<text::nf::c, char16_t> lhs(lhs_);
        text::basic_rope_view<text::nf::d, char16_t> rhs(rhs_);
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::d, char16_t> lhs_(u"role");
        text::basic_rope<text::nf::c, char16_t> rhs_(u"rôle");
        text::basic_rope_view<text::nf::d, char16_t> lhs(lhs_);
        text::basic_rope_view<text::nf::c, char16_t> rhs(rhs_);
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c, char16_t> lhs_(u"role");
    ...
    {
        text::basic_rope<text::nf::c, char16_t> nfc_(u"rôle");
        text::basic_rope<text::nf::d, char> nfd_((char const *)u8"rôle");
        text::basic_rope_view<text::nf::c, char16_t> nfc(nfc_);
        text::basic_rope_view<text::nf::d, char> nfd(nfd_);
        EXPECT_EQ(
            text::collation_sort_key(nfc, table),
            text::collation_sort_key(nfd, table));
    }
    {
        text::basic_rope<text::nf::d, char16_t> lhs_(u"role");
        text::basic_rope<text::nf::d, char> rhs_((char const *)u8"rôle");
        text::basic_rope_view<text::nf::d, char16_t> lhs(lhs_);
        text::basic_rope_view<text::nf::d, char> rhs(rhs_);
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c, char16_t> lhs_(u"role");
    ...
    {
        text::basic_rope<text::nf::d, char16_t> lhs_(u"role");
        text::basic_rope<text::nf::c, char> rhs_((char const *)u8"rôle");
        text::basic_rope_view<text::nf::d, char16_t> lhs(lhs_);
        text::basic_rope_view<text::nf::c, char> rhs(rhs_);
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c, char16_t> lhs_(u"role");
    ...
    {
        text::basic_rope<text::nf::c, char> nfc_((char const *)u8"rôle");
        text::basic_rope<text::nf::d, char16_t> nfd_(u"rôle");
        text::basic_rope_view<text::nf::c, char> nfc(nfc_);
        text::basic_rope_view<text::nf::d, char16_t> nfd(nfd_);
        EXPECT_EQ(
            text::collation_sort_key(nfc, table),
            text::collation_sort_key(nfd, table));
    ...
    {
        text::basic_rope<text::nf::d, char> lhs_((char const *)u8"role");
        text::basic_rope<text::nf::d, char16_t> rhs_(u"rôle");
        text::basic_rope_view<text::nf::d, char> lhs(lhs_);
        text::basic_rope_view<text::nf::d, char16_t> rhs(rhs_);
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
        text::basic_rope<text::nf::c, char> lhs_((char const *)u8"role");
        text::basic_rope<text::nf::d, char16_t> rhs_(u"rôle");
        text::basic_rope_view<text::nf::c, char> lhs(lhs_);
        text::basic_rope_view<text::nf::d, char16_t> rhs(rhs_);
        EXPECT_EQ(text::collate(lhs, rhs, table), -1);
    }
    {
