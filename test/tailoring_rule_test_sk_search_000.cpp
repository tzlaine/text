...
TEST(tailoring, sk_search_000_003)
{
    ...
    EXPECT_EQ(collate(
        ...
        std::vector<uint32_t>(1, 0x010f),
        table(), collation_strength::primary),
        -1);
    // greater than (or equal to, for =) preceeding cps
    EXPECT_EQ(collate(
        std::vector<uint32_t>(1, 0x010f),
        std::vector<uint32_t>(1, 0x010e),
        table(), collation_strength::tertiary),
        -1);
    // equal to preceeding cps at next-lower strength
    EXPECT_EQ(collate(
...
TEST(tailoring, sk_search_000_004)
{
    ...
    EXPECT_EQ(collate(
        ...
        std::vector<uint32_t>(1, 0x013a),
        table(), collation_strength::primary),
        -1);
    // greater than (or equal to, for =) preceeding cps
    EXPECT_EQ(collate(
        std::vector<uint32_t>(1, 0x013a),
        std::vector<uint32_t>(1, 0x0139),
        table(), collation_strength::tertiary),
        -1);
    // equal to preceeding cps at next-lower strength
    EXPECT_EQ(collate(
    ...
    EXPECT_EQ(collate(
        std::vector<uint32_t>(1, 0x0139),
        std::vector<uint32_t>(1, 0x013e),
        table(), collation_strength::primary),
        -1);
    // greater than (or equal to, for =) preceeding cps
    EXPECT_EQ(collate(
        std::vector<uint32_t>(1, 0x013e),
        std::vector<uint32_t>(1, 0x013d),
        table(), collation_strength::tertiary),
        -1);
    // equal to preceeding cps at next-lower strength
    EXPECT_EQ(collate(
    ...
    EXPECT_EQ(collate(
        ...
        std::vector<uint32_t>(1, 0x0165),
        table(), collation_strength::primary),
        -1);
    // greater than (or equal to, for =) preceeding cps
    EXPECT_EQ(collate(
        std::vector<uint32_t>(1, 0x0165),
        std::vector<uint32_t>(1, 0x0164),
        table(), collation_strength::tertiary),
        -1);
    // equal to preceeding cps at next-lower strength
    EXPECT_EQ(collate(
    ...
    EXPECT_EQ(collate(
        std::vector<uint32_t>(1, 0x00da),
        std::vector<uint32_t>(1, 0x016f),
        table(), collation_strength::primary),
        -1);
    // greater than (or equal to, for =) preceeding cps
    EXPECT_EQ(collate(
        std::vector<uint32_t>(1, 0x016f),
        std::vector<uint32_t>(1, 0x016e),
        table(), collation_strength::tertiary),
        -1);
    // equal to preceeding cps at next-lower strength
    EXPECT_EQ(collate(
