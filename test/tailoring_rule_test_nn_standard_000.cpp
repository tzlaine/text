...
collation_table make_save_load_table()
{
    ...
    string const table_str(data::nn::standard_collation_tailoring());
    return tailored_collation_table(
        table_str,
        "nn::standard_collation_tailoring()", error, warning);
#else
    if (!exists(boost::filesystem::path("nn_standard.table"))) {
        string const table_str(data::nn::standard_collation_tailoring());
        collation_table table = tailored_collation_table(
            table_str,
            "nn::standard_collation_tailoring()", error, warning);
        save_table(table, "nn_standard.table.0");
        boost::filesystem::rename("nn_standard.table.0", "nn_standard.table");
    }
    return load_table("nn_standard.table");
#endif
}
...
TEST(tailoring, nn_standard_000_001)
{
    {
