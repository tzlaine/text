...
TEST(normalization, nfkc_011_000)
{
    ...
    // (㌱; ㌱; ㌱; ビル; ヒ◌゙ル; ) SQUARE BIRU
    {
        ...
        std::array<uint32_t, 2> const dest = {{ 0x30D3, 0x30EB }};
...
TEST(normalization, nfkc_011_001)
{
    ...
    // (㌲; ㌲; ㌲; ファラッド; ファラット◌゙; ) SQUARE HUARADDO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 5> const dest = {{ 0x30D5, 0x30A1, 0x30E9, 0x30C3, 0x30C9 }};
...
TEST(normalization, nfkc_011_003)
{
    ...
    // (㌴; ㌴; ㌴; ブッシェル; フ◌゙ッシェル; ) SQUARE BUSSYERU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 5> const dest = {{ 0x30D6, 0x30C3, 0x30B7, 0x30A7, 0x30EB }};
...
TEST(normalization, nfkc_011_006)
{
    ...
    // (㌷; ㌷; ㌷; ペソ; ヘ◌゚ソ; ) SQUARE PESO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0x30DA, 0x30BD }};
...
TEST(normalization, nfkc_011_007)
{
    ...
    // (㌸; ㌸; ㌸; ペニヒ; ヘ◌゚ニヒ; ) SQUARE PENIHI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30DA, 0x30CB, 0x30D2 }};
...
TEST(normalization, nfkc_011_009)
{
    ...
    // (㌺; ㌺; ㌺; ペンス; ヘ◌゚ンス; ) SQUARE PENSU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30DA, 0x30F3, 0x30B9 }};
...
TEST(normalization, nfkc_011_010)
{
    ...
    // (㌻; ㌻; ㌻; ページ; ヘ◌゚ーシ◌゙; ) SQUARE PEEZI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30DA, 0x30FC, 0x30B8 }};
...
TEST(normalization, nfkc_011_011)
{
    ...
    // (㌼; ㌼; ㌼; ベータ; ヘ◌゙ータ; ) SQUARE BEETA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30D9, 0x30FC, 0x30BF }};
...
TEST(normalization, nfkc_011_012)
{
    ...
    // (㌽; ㌽; ㌽; ポイント; ホ◌゚イント; ) SQUARE POINTO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 4> const dest = {{ 0x30DD, 0x30A4, 0x30F3, 0x30C8 }};
...
TEST(normalization, nfkc_011_013)
{
    ...
    // (㌾; ㌾; ㌾; ボルト; ホ◌゙ルト; ) SQUARE BORUTO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30DC, 0x30EB, 0x30C8 }};
...
TEST(normalization, nfkc_011_015)
{
    ...
    // (㍀; ㍀; ㍀; ポンド; ホ◌゚ント◌゙; ) SQUARE PONDO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30DD, 0x30F3, 0x30C9 }};
...
TEST(normalization, nfkc_011_025)
{
    ...
    // (㍊; ㍊; ㍊; ミリバール; ミリハ◌゙ール; ) SQUARE MIRIBAARU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 5> const dest = {{ 0x30DF, 0x30EA, 0x30D0, 0x30FC, 0x30EB }};
...
TEST(normalization, nfkc_011_026)
{
    ...
    // (㍋; ㍋; ㍋; メガ; メカ◌゙; ) SQUARE MEGA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0x30E1, 0x30AC }};
...
TEST(normalization, nfkc_011_027)
{
    ...
    // (㍌; ㍌; ㍌; メガトン; メカ◌゙トン; ) SQUARE MEGATON
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 4> const dest = {{ 0x30E1, 0x30AC, 0x30C8, 0x30F3 }};
...
TEST(normalization, nfkc_011_029)
{
    ...
    // (㍎; ㍎; ㍎; ヤード; ヤート◌゙; ) SQUARE YAADO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30E4, 0x30FC, 0x30C9 }};
...
TEST(normalization, nfkc_011_034)
{
    ...
    // (㍓; ㍓; ㍓; ルピー; ルヒ◌゚ー; ) SQUARE RUPII
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30EB, 0x30D4, 0x30FC }};
...
TEST(normalization, nfkc_011_035)
{
    ...
    // (㍔; ㍔; ㍔; ルーブル; ルーフ◌゙ル; ) SQUARE RUUBURU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 4> const dest = {{ 0x30EB, 0x30FC, 0x30D6, 0x30EB }};
...
TEST(normalization, nfkc_011_037)
{
    ...
    // (㍖; ㍖; ㍖; レントゲン; レントケ◌゙ン; ) SQUARE RENTOGEN
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 5> const dest = {{ 0x30EC, 0x30F3, 0x30C8, 0x30B2, 0x30F3 }};
