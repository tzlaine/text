...
{
    text::detail::const_vector_iterator<int> it1;
    text::detail::const_vector_iterator<int> it2;
...
{
    {
        ...
        text::detail::const_vector_iterator<int> it(r_empty, 0);
...

    {
        ...
        text::detail::const_vector_iterator<int> first(r_a, 0);
        text::detail::const_vector_iterator<int> last(r_a, r_a.size());
...
{
    {
        text::detail::const_reverse_vector_iterator<int> it1;
        text::detail::const_reverse_vector_iterator<int> it2;
...
TEST(const_reverse_vector_iterator, test_c_str_ctor)
{
    {
        text::segmented_vector<int> r_empty;
        text::detail::const_reverse_vector_iterator<int> it = r_empty.rbegin();
    ...
    {
        text::segmented_vector<int> r_a({13});
        text::detail::const_reverse_vector_iterator<int> first = r_a.rbegin();
        text::detail::const_reverse_vector_iterator<int> last = r_a.rend();
...
TEST(both_vector_iterators, test_larger_sequences)
{
...

    {
        ...
        {
            text::detail::const_vector_iterator<int> first = r.begin();
            text::detail::const_vector_iterator<int> last = r.end();
            std::vector<int> const from_first_last(first, last);
            EXPECT_EQ(from_first_last, vec);
        }

        {
            text::detail::const_reverse_vector_iterator<int> first = r.rbegin();
            text::detail::const_reverse_vector_iterator<int> last = r.rend();
            std::vector<int> const from_first_last(first, last);
            EXPECT_EQ(from_first_last, vec);
        }
    }
