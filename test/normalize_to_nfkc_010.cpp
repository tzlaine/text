...
TEST(normalization, nfkc_010_013)
{
    ...
    // (㉴; ㉴; ㉴; 사; 사; ) CIRCLED HANGUL SIOS A
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 1> const dest = {{ 0xC0AC }};
...
TEST(normalization, nfkc_010_021)
{
    ...
    // (㉼; ㉼; ㉼; 참고; 참고; ) CIRCLED KOREAN CHARACTER CHAMKO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0xCC38, 0xACE0 }};
...
TEST(normalization, nfkc_010_022)
{
    ...
    // (㉽; ㉽; ㉽; 주의; 주의; ) CIRCLED KOREAN CHARACTER JUEUI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0xC8FC, 0xC758 }};
...
TEST(normalization, nfkc_010_151)
{
    ...
    // (㌀; ㌀; ㌀; アパート; アハ◌゚ート; ) SQUARE APAATO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 4> const dest = {{ 0x30A2, 0x30D1, 0x30FC, 0x30C8 }};
...
TEST(normalization, nfkc_010_153)
{
    ...
    // (㌂; ㌂; ㌂; アンペア; アンヘ◌゚ア; ) SQUARE ANPEA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 4> const dest = {{ 0x30A2, 0x30F3, 0x30DA, 0x30A2 }};
...
TEST(normalization, nfkc_010_155)
{
    ...
    // (㌄; ㌄; ㌄; イニング; イニンク◌゙; ) SQUARE ININGU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 4> const dest = {{ 0x30A4, 0x30CB, 0x30F3, 0x30B0 }};
...
TEST(normalization, nfkc_010_158)
{
    ...
    // (㌇; ㌇; ㌇; エスクード; エスクート◌゙; ) SQUARE ESUKUUDO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 5> const dest = {{ 0x30A8, 0x30B9, 0x30AF, 0x30FC, 0x30C9 }};
...
TEST(normalization, nfkc_010_165)
{
    ...
    // (㌎; ㌎; ㌎; ガロン; カ◌゙ロン; ) SQUARE GARON
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30AC, 0x30ED, 0x30F3 }};
...
TEST(normalization, nfkc_010_166)
{
    ...
    // (㌏; ㌏; ㌏; ガンマ; カ◌゙ンマ; ) SQUARE GANMA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30AC, 0x30F3, 0x30DE }};
...
TEST(normalization, nfkc_010_167)
{
    ...
    // (㌐; ㌐; ㌐; ギガ; キ◌゙カ◌゙; ) SQUARE GIGA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0x30AE, 0x30AC }};
...
TEST(normalization, nfkc_010_168)
{
    ...
    // (㌑; ㌑; ㌑; ギニー; キ◌゙ニー; ) SQUARE GINII
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30AE, 0x30CB, 0x30FC }};
...
TEST(normalization, nfkc_010_170)
{
    ...
    // (㌓; ㌓; ㌓; ギルダー; キ◌゙ルタ◌゙ー; ) SQUARE GIRUDAA
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 4> const dest = {{ 0x30AE, 0x30EB, 0x30C0, 0x30FC }};
...
TEST(normalization, nfkc_010_172)
{
    ...
    // (㌕; ㌕; ㌕; キログラム; キロク◌゙ラム; ) SQUARE KIROGURAMU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 5> const dest = {{ 0x30AD, 0x30ED, 0x30B0, 0x30E9, 0x30E0 }};
...
TEST(normalization, nfkc_010_175)
{
    ...
    // (㌘; ㌘; ㌘; グラム; ク◌゙ラム; ) SQUARE GURAMU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30B0, 0x30E9, 0x30E0 }};
...
TEST(normalization, nfkc_010_176)
{
    ...
    // (㌙; ㌙; ㌙; グラムトン; ク◌゙ラムトン; ) SQUARE GURAMUTON
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 5> const dest = {{ 0x30B0, 0x30E9, 0x30E0, 0x30C8, 0x30F3 }};
...
TEST(normalization, nfkc_010_177)
{
    ...
    // (㌚; ㌚; ㌚; クルゼイロ; クルセ◌゙イロ; ) SQUARE KURUZEIRO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 5> const dest = {{ 0x30AF, 0x30EB, 0x30BC, 0x30A4, 0x30ED }};
...
TEST(normalization, nfkc_010_181)
{
    ...
    // (㌞; ㌞; ㌞; コーポ; コーホ◌゚; ) SQUARE KOOPO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30B3, 0x30FC, 0x30DD }};
...
TEST(normalization, nfkc_010_184)
{
    ...
    // (㌡; ㌡; ㌡; シリング; シリンク◌゙; ) SQUARE SIRINGU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 4> const dest = {{ 0x30B7, 0x30EA, 0x30F3, 0x30B0 }};
...
TEST(normalization, nfkc_010_187)
{
    ...
    // (㌤; ㌤; ㌤; ダース; タ◌゙ース; ) SQUARE DAASU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30C0, 0x30FC, 0x30B9 }};
...
TEST(normalization, nfkc_010_188)
{
    ...
    // (㌥; ㌥; ㌥; デシ; テ◌゙シ; ) SQUARE DESI
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0x30C7, 0x30B7 }};
...
TEST(normalization, nfkc_010_189)
{
    ...
    // (㌦; ㌦; ㌦; ドル; ト◌゙ル; ) SQUARE DORU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0x30C9, 0x30EB }};
...
TEST(normalization, nfkc_010_194)
{
    ...
    // (㌫; ㌫; ㌫; パーセント; ハ◌゚ーセント; ) SQUARE PAASENTO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 5> const dest = {{ 0x30D1, 0x30FC, 0x30BB, 0x30F3, 0x30C8 }};
...
TEST(normalization, nfkc_010_195)
{
    ...
    // (㌬; ㌬; ㌬; パーツ; ハ◌゚ーツ; ) SQUARE PAATU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30D1, 0x30FC, 0x30C4 }};
...
TEST(normalization, nfkc_010_196)
{
    ...
    // (㌭; ㌭; ㌭; バーレル; ハ◌゙ーレル; ) SQUARE BAARERU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 4> const dest = {{ 0x30D0, 0x30FC, 0x30EC, 0x30EB }};
...
TEST(normalization, nfkc_010_197)
{
    ...
    // (㌮; ㌮; ㌮; ピアストル; ヒ◌゚アストル; ) SQUARE PIASUTORU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 5> const dest = {{ 0x30D4, 0x30A2, 0x30B9, 0x30C8, 0x30EB }};
...
TEST(normalization, nfkc_010_198)
{
    ...
    // (㌯; ㌯; ㌯; ピクル; ヒ◌゚クル; ) SQUARE PIKURU
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 3> const dest = {{ 0x30D4, 0x30AF, 0x30EB }};
...
TEST(normalization, nfkc_010_199)
{
    ...
    // (㌰; ㌰; ㌰; ピコ; ヒ◌゚コ; ) SQUARE PIKO
    {
        ...
        boost::text::string str = boost::text::to_string(source.begin(), source.end());
        std::array<uint32_t, 2> const dest = {{ 0x30D4, 0x30B3 }};
