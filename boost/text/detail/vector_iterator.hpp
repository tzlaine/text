...
namespace boost { namespace text { namespace detail {
    ...
    struct const_vector_iterator
    {
        ...
        const_vector_iterator (segmented_vector<T> const & v, difference_type n) noexcept :
            vec_ (&v),
            n_ (n),
            leaf_ (nullptr),
            leaf_start_ (0)
        ...
        friend bool operator== (const_vector_iterator lhs, const_vector_iterator rhs) noexcept
        ...
        friend const_vector_iterator operator+ (const_vector_iterator lhs, difference_type rhs) noexcept
        { return lhs += rhs; }
        friend const_vector_iterator operator+ (difference_type lhs, const_vector_iterator rhs) noexcept
        { return rhs += lhs; }
        friend const_vector_iterator operator- (const_vector_iterator lhs, difference_type rhs) noexcept
        { return lhs -= rhs; }
        friend const_vector_iterator operator- (difference_type lhs, const_vector_iterator rhs) noexcept
        { return rhs -= lhs; }
        friend difference_type operator- (const_vector_iterator lhs, const_vector_iterator rhs) noexcept
        {
    ...
    private:
        ...
        T const & deref () const
        {
            ...
            case leaf_node_t<T>::which::ref: {
                ...
                return *(ref->vec_.as_leaf()->as_vec().begin() + ref->lo_ + (n_ - leaf_start_));
            }
    ...
    struct const_reverse_vector_iterator
    {
        ...
        explicit const_reverse_vector_iterator (const_vector_iterator<T> it) noexcept : base_ (it) {}
        ...
        const_reverse_vector_iterator & operator++ () noexcept { --base_; return *this; }
        ...
        const_reverse_vector_iterator & operator+= (difference_type n) noexcept { base_ -= n; return *this; }
        ...
        friend bool operator== (const_reverse_vector_iterator lhs, const_reverse_vector_iterator rhs) noexcept
        ...
        friend const_reverse_vector_iterator operator+ (const_reverse_vector_iterator lhs, difference_type rhs) noexcept
        { return lhs += rhs; }
        friend const_reverse_vector_iterator operator+ (difference_type lhs, const_reverse_vector_iterator rhs) noexcept
        { return rhs += lhs; }
        friend const_reverse_vector_iterator operator- (const_reverse_vector_iterator lhs, difference_type rhs) noexcept
        { return lhs -= rhs; }
        friend const_reverse_vector_iterator operator- (difference_type lhs, const_reverse_vector_iterator rhs) noexcept
        { return rhs -= lhs; }
        friend difference_type operator- (const_reverse_vector_iterator lhs, const_reverse_vector_iterator rhs) noexcept
        { return rhs.base_ - lhs.base_; }
